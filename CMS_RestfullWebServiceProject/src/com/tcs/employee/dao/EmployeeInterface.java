...
public interface EmployeeInterface {
	...
	// By Amit
	public Employee update(Employee employee) throws ClassNotFoundException,
			SQLException;
	
	
	//By Shalabh
	public ArrayList<Wallet> showWallet(String id) throws ClassNotFoundException, SQLException;
	
	//By Ram 
	public ArrayList<Vendor> displayVendorList() throws ClassNotFoundException,SQLException;
	...
	// By Prashanti
	public boolean addWallet(String e_id, String v_id) throws ClassNotFoundException,
			SQLException;
	...
	//By Sishir
	public boolean rechargeWallet(String e_id, String v_id, double amount) throws ClassNotFoundException,
	SQLException;
}
