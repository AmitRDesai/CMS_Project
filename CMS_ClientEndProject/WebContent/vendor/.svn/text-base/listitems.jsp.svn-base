...
<div class="wrapper">
	...
	<div class="bd-example" align="center">
		...
		<%
			...
			ArrayList<Item> iList = (ArrayList<Item>)request.getAttribute("products");
					...
					<div class="modal-body">
						...
						<form>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text"
										value="<%=item.getI_id()%>" required pattern='[0-9]+' disabled="disabled">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text"
										value="<%=item.getV_id()%>" required pattern='[0-9]+'disabled="disabled">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text"
										value="<%=item.getI_name()%>" required pattern="[a-zA-Z]{1,}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text"
										value="<%=item.getI_price()%>" required pattern='[0-9]+'>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text"
										value="<%=item.getI_type()%>" required pattern="[a-zA-Z]{1,}">
								</div>
							</div>
