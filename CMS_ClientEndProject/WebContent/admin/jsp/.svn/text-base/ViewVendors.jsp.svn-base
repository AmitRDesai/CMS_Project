        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin Nanme</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../jsp/AddVendor.jsp"><i class="fa fa-circle-o"></i>Add Vendor</a></li>
            <li><a href="../jsp/UpdateVendor.jsp"><i class="fa fa-circle-o"></i> Update Vendor</a></li>
            <li><a href="../jsp/DeleteVendor.jsp"><i class="fa fa-circle-o"></i> Delete Vendor</a></li>
            <li><a href="ViewVendors.jsp"><i class="fa fa-circle-o"></i>View Users</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i>Verify Menu</a></li>
            <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i>View Menu</a></li>            
          </ul>
        </li>     
        <li class="active treeview">
          <a href="#">
