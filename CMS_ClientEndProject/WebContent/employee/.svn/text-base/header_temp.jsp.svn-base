...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li><a
				href="${pageContext.request.contextPath}/ControllerServlet?action=myWallet&e_id=${employee.e_id}">My Wallet</a></li>
			 <li><a 
				href="${pageContext.request.contextPath}/employee/dashboard.jsp">Place Order</a></li> 
		...
		<c:when test="${employee.e_id ne ''}">
			...
			<li><a href="${pageContext.request.contextPath}/employee/account.jsp"><span class="glyphicon glyphicon-user"></span>
					${employee.e_name}</a>
